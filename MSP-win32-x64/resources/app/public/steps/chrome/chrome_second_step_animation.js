...
// library properties:
	lib.properties = {
		...
		opacity: 1.00,
		manifest: [
			{src:"media/chrome_atlas_.png?1469601148598", id:"chrome_atlas_"}
		]
	};
	...
	lib.ssMetadata = [
		{name:"chrome_atlas_", frames: [[0,0,522,279],[222,281,186,499],[0,281,220,500]]}
	];
...
// symbols:
	...
	(lib.chrome_plugins = function() {
		this.spriteSheet = ss["chrome_atlas_"];
		this.gotoAndStop(0);
	...
	(lib.Анимация1 = function(mode,startPosition,loop) {
		...
		// Слой 1
		this.instance = new lib.chrome_plugins();
		this.instance.setTransform(-261,-139.5);

		this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	}).prototype = p = new cjs.MovieClip();
	p.nominalBounds = new cjs.Rectangle(-261,-139.5,522,279);
...
// stage content:
	(lib.girl_boy_chrome = function(mode,startPosition,loop) {
		this.initialize(mode,startPosition,loop,{});
		...
		this.instance_10.setTransform(1196,-204.3);
		this.instance_10._off = true;

		this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(34).to({_off:false},0).to({y:329.5},13).wait(752));
